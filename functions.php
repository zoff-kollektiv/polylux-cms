...
function allowed_block_types()
{
    ...
    $allowed_core_blocks = ['core/heading', 'core/paragraph', 'core/button'];
...
function register_footer_widgets()
{
    register_sidebar(array(
        ...
        'before_widget' =>
            '<aside class="footer-widget footer-widget--account">',
        'after_widget' => '</aside>',
    ...
    register_sidebar(array(
        ...
        'before_widget' =>
            '<aside class="footer-widget footer-widget--contact">',
        'after_widget' => '</aside>',
        'before_title' => '<h3 class="footer-widget__title">',
        'after_title' => '</h3>'
    ));
